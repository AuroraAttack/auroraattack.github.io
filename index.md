...
This repo stores attack chains generated by Aurora, which can be found in the [exapmle](https://github.com/LexusWang/Aurora-demos/tree/main/examples) folder. Each folder in `examples` contains an attach chain, which includes the emulation plan details and attack steps.
